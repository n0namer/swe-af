...
- Cron `swe-governor-decisions-v1`, id `c7ea3f43-2a02-4752-aaac-f254f9ba256f`, remains enabled every 20s, command `node /home/node/.openclaw/workspace/skills/swe-governor/scripts/swe-governor.mjs notify`, `delivery.mode=none`, `timeoutSeconds=15`; after the latest adapter change CURRENT cron readback is `ok`, `147ms`, diagnostic `NO_REPLY`, errors/skips `0`.
