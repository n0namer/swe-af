...
- Current clean precondition for Attempt 6: sacrificial repo `/tmp/swe-af-fullbuild-current-20260912` remains on exact SHA `cdc39105e92937e0085410a656346471b2dc6834`; AgentField exact candidate remains `c0923acdfca043c2c07e3d34daaa09e2a7e41d38`; planner remains `/tmp/swe-planner-agentfield-c092-20260913` SHA256 `c923a3653cceddbbc0672f6c6b8b673f3b819ef15751878e255014a9d0732e79`. Before Attempt 6 START re-check worktree cleanliness, zero live mutators and node instance identity; use the exact frozen Build config from the experiment manifest.
