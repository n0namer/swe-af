...
- Current exact tested planner binary: `/tmp/swe-planner-fullbuild-f08-20260912`, SHA256 `f5adc31c29b3383f463f34df6863d3e06767e7904930b45b5f06463dd4a0d0de`; current planner PID `535405` after the controlled F06 restart probe, callback/health on port `8005`, control-plane active at registered callback `http://172.16.22.7:8005`.
...
- active gaps: **F05/F06 control-plane crash/restart/stale-state**. F06 is now reproduced and root-caused to the AgentField Go-agent process-identity/restart contract; it is a supporting-platform release blocker, not an unlocalized SWE defect.
