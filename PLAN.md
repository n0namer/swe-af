...
Run **FB-0 full `swe-planner.build` attempt 5** on clean frozen baseline `cdc39105e92937e0085410a656346471b2dc6834` with planner `/tmp/swe-planner-f06-sdk-20260913` (SHA256 `581862f59722400ee0999176339dfb99f8dc67cd7901bf39d9861caa5df4d4`), `fcm/fcm`, and existing recovery controls. Preconditions: planner active/ready with non-empty `instance_id`, zero live OpenCode process targeting the workspace, clean target Git status. After START make zero operator task-code edits. Stop at autonomous terminal success + canonical validation/oracle, or the first new evidence-backed full-lifecycle blocker.
