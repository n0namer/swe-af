...
- `AGENTS.md` now owns the global pre-routing rule, while `skills/swe-governor/SKILL.md` owns the conversation/final-action policy. CURRENT SHA256: `AGENTS.md` `7f5ebb8f92b82b4577246723d3d75dec28c922bb0ef04fe7dfd493ba0c82a42d`, skill `c694c1e6550715f0bdd06bc348135ed76ca4af8ec3636adf146d8806cc30fafe`, adapter `35aed5d89595201a09841cfa393f86a117e0c868a5598760ab181117dafe4903`.
- Earlier synthetic A/B/test cards were removed after evidence capture. One intentionally live, non-mutating routing canary now remains: request `openclaw-routing-canary-20260905`, kind `routing_canary`, Telegram message id `14072`. The adapter resolves `route 14072` to that exact request and refuses terminal mutation for this kind (`reject` fails locally). Its sole purpose is the remaining physical inbound proof: a real operator Telegram Reply should be correlated to this thread, allow multi-message `discuss`, and never touch `/webhooks/approval`.
