...
- `AGENTS.md` owns the compatibility pre-routing rule for the current shared Jarvis bot, while `skills/swe-governor/SKILL.md` owns SWE conversation/final-action/project policy. CURRENT SHA256: `AGENTS.md` `7f5ebb8f92b82b4577246723d3d75dec28c922bb0ef04fe7dfd493ba0c82a42d`, skill `03ee024c1683410887571186c612d19e40d8b760b63431a6b880c2acbd7a20c0`, adapter `33df0d850aebcc8e3c69667e75fd325b5a50894e41c3633d4976e08d9ba59946`.
- All synthetic Telegram routing canaries, including message `14072`, were removed after evidence capture and their state entries deleted. The target UX no longer depends on proving ambiguous routing inside the shared Jarvis DM; the dedicated `swe` account removes that ambiguity by channel binding.
